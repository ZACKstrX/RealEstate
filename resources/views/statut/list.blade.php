        ...
        <tbody>
            @foreach ($statuses as $status)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-secondary me-3" data-bs-toggle="modal" data-bs-target="#updateStatusModal"
                            data-status-id="{{ $status->id }}" data-status-name="{{ $status->name }}">Update</a>
            ...
            <div class="modal-body">
                <form id="updateStatusForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="updateStatusName"
